...
import { types, setPropertyList } from '../../reducers/propertyList/propertyListReducer'

const getPropertyListEpic = action$ =>
  action$
    .ofType(types.FETCH_PROPERTY_LIST)
    .mergeMap(() =>
      Observable.merge(
        Observable.of(
          // TODO: actions to show spinner, set initial error handling object...
        ),
...
export default getPropertyListEpic
